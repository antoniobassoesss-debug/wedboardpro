    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ margin: '16px 0 8px 0' }}>Create your WedBoarPro account</h1>
          <p style={{ margin: 0, color: '#6b6b6b' }}>Set up access for your planning studio.</p>
        </div>
        ...
        <p style={{ marginTop: 24, textAlign: 'center', fontSize: 14, color: '#6b6b6b' }}>
          ...
          <Link to="/login" style={{ color: '#0c0c0c', fontWeight: 600 }}>
            Log in
          </Link>
        </p>
      </div>
